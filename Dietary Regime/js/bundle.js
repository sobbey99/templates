...
function cards() {
    //Will use classes for cards | Not using cards but function constructor forEach data which received from JSON
...
function allForms(formSelector, modalTimerId) {
    //FORMS
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (allForms);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function useSlider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    // 1) SLider
...
window.addEventListener('DOMContentLoaded', () => {
      ...
      const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimerId), 50000);
               ...
               (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2023-01-21');
